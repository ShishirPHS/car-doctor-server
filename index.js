...
app.use(
  cors({
    ...
    origin: [
      "https://car-doctor-f041a.web.app",
      "https://car-doctor-f041a.firebaseapp.com",
      "http://localhost:5173",
      "http://localhost:5174",
    ],
    credentials: true,
...
async function run() {
  try {
    ...
    // get specific service info from database
    ...
    // insert order to bookings collection
    ...
    // delete booking data from bookings collection
